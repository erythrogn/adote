...
class _AddChatUsersWidgetState extends State<AddChatUsersWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.textController?.text = 'Procurar amigos ';
        }));
  }
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              'Seleciones os amigos para adicionar ao chat.',
