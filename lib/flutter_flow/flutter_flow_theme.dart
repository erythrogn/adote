...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF867A00);
  late Color secondary = const Color(0xFF798206);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFF8E400);
  late Color primaryText = const Color(0xFFF6F6F6);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFFA77800);
  late Color secondaryBackground = const Color(0xFFE6CF78);
  ...
  late Color info = const Color(0xFF94651C);

  late Color primaryDark = Color(0xFF1A1F24);
  late Color background = Color(0xFF867A00);
  late Color grayIcon = Color(0xFF95A1AC);
  late Color gray200 = Color(0xFFFFFF00);
  late Color dark600 = Color(0xFF262D34);
  late Color customColor1 = Color(0xFF5CA42A);
  late Color customColor2 = Color(0xFF95064B);
  late Color customColor3 = Color(0xFFF0D638);
}
